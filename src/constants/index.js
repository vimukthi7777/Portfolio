...
export const projects = [
  {
    ...
    description:
      "A dynamic online store for mobile accessories like cases, chargers, cables, and power banks. Built with React, styled with Tailwind CSS, and enhanced with GSAP animations for smooth interactive UI effects.",
...
export const socials = [
  ...
  { name: "LinkedIn", href: "www.linkedin.com/in/sahan-galaboda-040943306" },
